...
Rule 11: the name of each test is the claim. Both are red at 5b72329 -- the first fails
because the guard fires on an inventory, and the second is the half that must keep working
and is what stops the fix from being "delete the guard".
"""
