...
| I-9, I-10 | `integration/test_authorize_postgres.py::test_authorize_persists_adr_and_outbox_atomically` (strict claim validation, CAS/replay signal, epoch/constraint/profile checks; B-8 blocks fresh context/argument recomputation) |
