...
| V-24 | `unit/test_identity_key_rotation.py::test_rotation_drill_accepts_both_keys_only_during_overlap`; `unit/test_identity_key_rotation.py::test_identity_token_without_kid_is_refused_before_signature_verification`; `unit/test_identity_key_rotation.py::test_identity_token_cannot_change_the_algorithm_bound_to_its_kid`; `unit/test_identity_key_rotation.py::test_identity_keyset_rejects_duplicate_kids`; `unit/test_identity_key_rotation.py::test_identity_keyset_rejects_private_key_material`; `unit/test_identity_key_rotation.py::test_identity_keyset_rejects_symmetric_algorithms` |
| V-25 | `unit/test_drain_worker.py::test_the_worker_reconciles_database_receipts_with_the_bucket_stream` + `unit/test_drain_worker.py::test_reconciliation_rejects_a_bucket_record_with_no_database_receipt` + `integration/test_evidence_export_postgres.py::test_operator_export_verifies_and_a_missing_bucket_segment_fails_readiness` |
| V-26 | `unit/test_app_routes.py::test_approval_burst_is_refused_before_the_mutation_and_visible_in_metrics` + `unit/test_authorization.py::test_authorize_uses_the_registered_tool_tier_and_stops_before_evaluation` + `unit/test_authorization.py::test_idempotent_retry_returns_the_recorded_decision_after_capacity_is_exhausted` + `adversarial/test_rate_limits.py::test_burst_over_the_low_tier_limit_never_reaches_the_protected_handler` |
| V-27 | `unit/test_authorization.py::test_policy_backend_failure_is_truthfully_marked_degraded_and_fail_closed` + `unit/test_authorization.py::test_i8_risk_engine_failure_persists_system_fail_closed_deny` |
...
| Production builds a runtime, not only refusals (T-101) | `integration/test_production_boot.py::test_production_builds_a_runtime` + `integration/test_production_boot.py::test_the_readiness_probe_reports_what_this_process_can_actually_do` |
| Production full journey reaches attested export and both verifiers (T-131) | `integration/test_production_e2e.py::test_production_journey_attests_exports_and_both_verifiers_agree` |
| Workforce OIDC mapping, short sessions, step-up, logout and revocation (T-132) | `unit/test_workforce.py::test_oidc_callback_maps_customer_groups_and_records_a_hardware_step_up` + `unit/test_workforce.py::test_high_risk_step_up_must_be_recent` + `integration/test_workforce_postgres.py::test_browser_requests_refuse_expired_and_revoked_sessions_and_leave_audit_events` |
| A library that logs per request cannot drown the security lines (T-101) | `unit/test_observability.py::test_a_library_that_logs_every_request_does_not_drown_the_lines_that_matter` |
| B-21 — evidence immutability enforced by storage, not by our care (T-104) | `integration/test_object_lock_store.py::test_the_storage_layer_refuses_to_delete_what_it_has_locked` + `integration/test_object_lock_store.py::test_a_bucket_without_object_lock_is_refused_by_name` |
| Evidence written by one replica is readable by another (T-104) | `integration/test_object_lock_store.py::test_a_segment_written_by_one_replica_is_readable_by_another` + `integration/test_object_lock_store.py::test_rewriting_a_key_with_different_bytes_is_a_collision` |
