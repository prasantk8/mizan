...
| Invariant property tests I-1..I-26 + V-rule tests V-1..V-21 (SPEC §6, §9) | **TEST** | Hypothesis/property-based; each invariant and each V-rule ⇒ ≥1 named test. I-13 (representability) is generative: valid contexts must never fail ADR construction. |
